...
export const registerUser = async (req, res) => {
    try {
      ...
      const otpExpires = Date.now() + 30 * 60 * 1000; //  OTP Valid for 30 Minutes
      ...
      res.status(201).json({ message: "User registered successfully. Check your email for OTP & verification link." });
...
export const getAllUsers = async (req, res) => {
  ...
  export const loginUser = async (req, res) => {
    try {
      ...
      //Check Karo Ki Email Verified Hai Ya Nahi
      if (!user.isVerified) {
...
export const verifyLoginOTP = async (req, res) => {
  try {
    console.log("✅ OTP Verification Request Received:", req.body); // Debugging ke liye
    ...
    console.log("✅ User Found:", user.email, "Stored OTP:", user.otp, "Expiry:", user.otpExpires);

    // ✅ Check Karo Ki OTP Valid Hai Ya Nahi
    ...
    // ✅ OTP Ko Database Se Remove Karo
    user.otp = undefined;
